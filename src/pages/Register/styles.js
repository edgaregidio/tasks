...
export const HeaderRegister = styled.View`
  ...
  margin-bottom: 20px;
`
export const TitleRedister = styled.Text`
  font-size: 26px;
  font-weight: 600;
  color: ${props => props.theme.primaryColors.color};
`

export const TextDescriptonRegister = styled.Text`
  color: ${props => props.theme.secondyColors.color};
`
export const BodyRegister = styled.View`
  justify-content: center;
  align-items: center;
  width: 80%;
`
export const WrapperInput = styled.View`
  ...
  border-radius: 8px;
`
export const ContentIconRegister = styled.View`
  width: 20%;
  height: 70px;
  justify-content: center;
  align-items: center;
...
export const ButtonRegister = styled(TouchableOpacity)`
  ...
  margin-top: 20px;
`
export const TextInputRegister = styled.Text`
  font-size: 18px;
  color: #fff;
  font-weight: 600;
`
